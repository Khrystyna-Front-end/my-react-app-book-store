export const books = [
  {
    ...
    price: 10.99,
    level: "For developers at all levels",
    image:
    ...
    tags: "Types, values, variables, expressions, operators, statements, objects, and arrays, Functions, classes, modules, iterators, generators, Promises, and async/await, JavaScript’s standard library: data structures, regular expressions, JSON, i18n, etc., Node.js: buffers, files, streams, threads, child processes, web clients, and web servers",
    shortDescription:
  ...
  },
  {
    ...
    tags: "Internal abstraction, well-written tests, well-documented code,SOLID principles, OOP, functional programming, building UIs, managing APIs, and writing states",
    shortDescription:
  ...
  },
  {
    ...
    tags: "Node.js, Express.js, Apollo-Server, MongoDB, Web, React, Apollo-Client, Styled-Components",
    shortDescription:
  ...
  },
  {
    ...
    price: 18.99,
    level:
      "For web developers and software engineers who understand how JavaScript, CSS, and HTML work in the browser",
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@learning_react_2nd_edition.jpg",
    title: "Learning React, 2nd Edition",
    tags: " State management, React Router, testing, and server rendering",
    shortDescription:
  ...
  },
  {
    ...
    tags: " State management, React Router, Web, React",
    shortDescription:
  ...
  },
  {
    ...
    price: 15.99,
    level:
      "Web designer or app developer interested in sophisticated page styling",
    image:
    ...
    tags: "Colors, backgrounds, and gradients, floats and positioning tricks, flexible box layout, 2D and 3D transforms, transitions, and animation, filters, blending, media and feature queries",
    shortDescription:
  ...
  },
  {
    ...
    tags: "TDD in Go, JavaScript, and Python",
    shortDescription:
  ...
  },
  {
    ...
    price: 29.99,
    level:
      "For anyone who is looking to get started with Angular (2.0 and onward)",
    image:
    ...
    tags: "TypeScript, Angular, HTTP calls",
    shortDescription:
  ...
  },
  {
    ...
    price: 6.99,
    level: "For everyone who programming",
    image:
    ...
    tags: " AJAX, RIA(rich internet applications), SilverLight, Flex, and JavaFX",
    shortDescription:
  ...
  },
  {
    ...
    author: "Ido Green",
    price: 14.99,
    level: "For beginners developers",
    image: "",
    title: "Web Workers: Multithreaded Programs in JavaScript",
    tags: " Web Workers, debugging Web Workers, API",
    shortDescription:
  ...
  },
  {
    ...
    title: "WebSocket",
    tags: " WebSocket API events, WebSocket for STOMP 1.0",
    shortDescription:
  ...
  },
  {
    ...
    price: 14.49,
    level:
      " For administrators and back-end programmers and for web developers who accept the responsibility that comes with using the new wonders of the Web",
    image:
    ...
    tags: "HTTP, XML, JSON, RSS, ATOM, REST, and XDOS",
    shortDescription:
  ...
  },
  {
    ...
    price: 26.49,
    level: " For everyone who using Git as version control system",
    image:
    ...
    tags: "Cases, initial tasks, and basic functions, manage merges, conflicts, patches, and diffs",
    shortDescription:
  ...
  },
  {
    ...
    price: 29.49,
    level: "For beginners and professionals",
    image:
  ...
  },
  {
    ...
    title: "Learning Git",
    tags: "GitHub, GitLab, or Bitbucket",
    shortDescription:
  ...
  },
  {
    ...
    price: 21.49,
    level:
      "For Web developers who will discover ways to adapt designs by adding data based graphics, dynamic styles, interaction, or animation",
    image:
    ...
    tags: "SVG, graphical effects like filters, clipping, and masking",
    shortDescription:
  ...
  },
  {
    ...
    price: 28.39,
    level: "From Common UX Implementations to Complex Responsive Animation",
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@svg_animations.jpg",
    title: "SVG Animations",
    tags: "HTTP requests and crispness, VG cross-browser compatible, debug animation",
    shortDescription:
  ...
  },
  {
    ...
    price: 7.39,
    level: "A User-Centered Approach to Creating Efficient Workflows in Git",
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@git_for_teams.jpg",
    title: "Git for Teams",
    tags: "GitHub, Bitbucket, and GitLab",
  ...
  },
  {
    ...
    price: 38.49,
    level:
      "For web developments who have skills from browser and want get it to server with Node",
    image:
    ...
    tags: "Frameworks and functionality for full-stack Node development, Node’s REPL console, HTTP server ",
    shortDescription:
  ...
  },
  {
    ...
    price: 41.89,
    level:
      "For developers who know how to use JavaScript in the browser, and already want to have the skills for putting JavaScript to work on back-end servers with Node",
    image:
    ...
    tags: "Node, GET and POST requests, Socket.IO module",
    shortDescription:
